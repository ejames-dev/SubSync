...
### Fixed
- Windows portable releases now generate and publish `latest.yml` during
  `electron-builder --publish always`, restoring in-app auto-update for CI
  and local publish flows (fixes #41).
