...
export function getSqliteFilePath(databaseUrl = process.env.DATABASE_URL): string {
...
export function getBackupDirectory(databaseUrl = process.env.DATABASE_URL): string {
